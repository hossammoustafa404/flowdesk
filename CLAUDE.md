...
This is an Nx monorepo: `apps/web` and `apps/admin` (Next.js), `apps/server` (NestJS API), `packages/schemas` (@flowdesk/schemas, shared Zod schemas). Detailed engineering standards live in `docs/rules/`.
